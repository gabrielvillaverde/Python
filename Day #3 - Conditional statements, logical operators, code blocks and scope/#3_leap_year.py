# In this programming exercise, you will be creating a program that determines whether a given year is a leap year or not. 
# A leap year is one that has an additional day, February 29th, instead of February 28th in non-leap years.

# RULE: on every year that is evenly divisible by 4, **EXCEPT** every year that is evenly divisible by 100, **UNLESS** the year is also evenly divisible by 400.   
